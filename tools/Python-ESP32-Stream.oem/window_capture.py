...
class WindowScreenshotter:
    """
    Class for capturing screenshots of a specific window.
    Screenshot size can be adjusted to match target resolution.
    """
    def __init__(self, window_title=None, crop_alignment='center', resolution=(320, 170)):
        """
        Initializes the screenshot capture class.

        Args:
            window_title (str, optional): Title of the window to capture.
            crop_alignment (str): Crop alignment when aspect ratios don't match.
                Can be 'left', 'center', or 'right'.
            resolution (tuple): Target resolution (width, height) for the screenshot.
        """
